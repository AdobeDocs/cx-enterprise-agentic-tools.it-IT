...
<div class="columns">
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Puoi presentare i confronti tra Customer Journey Analytics e le tendenze di conversione attraverso domande in linguaggio semplice. Utilizza il gateway MCP di CX Enterprise.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Controlla lo stato di attivazione del pubblico e lo stato di salute della destinazione di Real-Time CDP senza navigare nell’interfaccia utente della piattaforma. Utilizza il gateway MCP di CX Enterprise.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Ottieni piena visibilità sui percorsi AJO attivi e sulla configurazione della campagna senza aprire AJO. Utilizza il gateway MCP di CX Enterprise.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Passa da Analytics insight all’aggiornamento pubblicato in una sessione, senza cambiare strumento. Utilizza il gateway MCP di CX Enterprise e il server MCP di AEM Content.</p>
                </div>
        ...
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    ...
                    <p class="is-size-6">Rivedi lo stato del percorso AJO, l’attivazione del pubblico Real-Time CDP e i dati sulle prestazioni di CJA in una sessione di intelligenza artificiale. Utilizza il gateway MCP di CX Enterprise.</p>
                </div>
    ...
    <div class="column is-half-tablet is-half-desktop is-one-third-widescreen" aria-label="Manage AEM environments with Cloud Manager">
        <div class="card" style="height: 100%; display: flex; flex-direction: column; height: 100%;">
            <div class="card-image">
                <figure class="image x-is-16by9">
                    <a href="use-cases/aem-cloud-manager-mcp.md" title="Gestire gli ambienti AEM con Cloud Manager" target="_blank" rel="referrer">
            ...
            <div class="card-content is-padded-small" style="display: flex; flex-direction: column; flex-grow: 1; justify-content: space-between;">
                <div class="top-card-content">
                    <p class="headline is-size-6 has-text-weight-bold">
                        <a href="use-cases/aem-cloud-manager-mcp.md" target="_blank" rel="referrer" title="Gestire gli ambienti AEM con Cloud Manager">Gestione degli ambienti AEM con Cloud Manager</a>
                    </p>
