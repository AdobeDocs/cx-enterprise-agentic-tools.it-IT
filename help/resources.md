...
![Risorse](https://placehold.co/1600x900?text=Adobe+CX+Enterprise+Resources)

Tutte le risorse chiave di Adobe per l&#39;utilizzo di Adobe CX Enterprise Agentic Tools, in un&#39;unica posizione.
...
| [Documentazione di Real-Time CDP MCP](https://experienceleague.adobe.com/it/docs/experience-cloud-ai/experience-cloud-ai/mcp/mcp-product-tools/rtcdp-mcp) | Guida alla configurazione del server RTCDP MCP |
...
| [API per la privacy](https://experienceleague.adobe.com/it/docs/experience-platform/privacy/home) | Flussi di lavoro sulla privacy, governance dei dati, richieste degli interessati |
| [API gestione utenti](https://developer.adobe.com/umapi/) | Gestione degli utenti, amministrazione delle identità, account aziendali |
| [API di Audience Manager](https://developer.adobe.com/audience-manager/) | Flussi di lavoro di attivazione e gestione dell’audience |

## Configurazione sviluppatore

| Risorsa | Cosa troverai |
|---|---|
| [Adobe Developer Console](https://developer.adobe.com/developer-console/docs/guides/) | Configurazione del progetto API, autenticazione e gestione delle credenziali |
| [Guida introduttiva per sviluppatori](https://developer.adobe.com/dep/) | Introduzione alla creazione con le API di Adobe |

## Configurazione client di IA

| Risorsa | Cosa troverai |
|---|---|
| [Documentazione MCP codice Claude](https://docs.anthropic.com/en/docs/claude-code/mcp) | Come aggiungere server MCP a Claude Code |
| [Cenni preliminari sul codice Claude](https://docs.anthropic.com/en/docs/claude-code/overview) | Guida introduttiva a Claude Code |
